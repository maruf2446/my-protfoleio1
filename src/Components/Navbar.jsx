            ...
            <div className='flex items-center justify-between'>
                <div className='mx-7'>
                    <h3 className='text-4xl uppercase font-bold'>
                        M<span className='text-cyan-600'>aru</span>F
                    </h3>
                </div>
                ...
                <div className={`md:hidden text-gray-900 absolute w-2/3 h-screen px-7 py-2 font-medium bg-white top-0 duration-300 ${
